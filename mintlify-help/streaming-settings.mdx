...
On Linux, held streaming displays text in the live preview and pastes it once you release the key. This avoids sending Ctrl+V while your push-to-talk modifier is still held.
