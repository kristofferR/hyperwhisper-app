...
On macOS, Windows, and Linux, turn on **Streaming** and **Use streaming for push-to-talk** to transcribe while you hold the key. Release the key to finish the stream and deliver any remaining text. Choose the provider in **Streaming** and the held key in **Settings → Shortcuts**. Turn off **Double-press to lock** if you only want hold-to-talk. If Streaming is off, push-to-talk uses regular recording.
